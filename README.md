...
| ⚠️ | `error` | The turn died on an API error — there's nothing to read, retry it |
...
most needs you, ranked **question → error → plan → done → running → shells → loop**.

**Only ✅ ever clears.** 🔄 / ❓ / 📝 / ⚠️ / ⏳ / 🌀 describe live state, and looking at a window
